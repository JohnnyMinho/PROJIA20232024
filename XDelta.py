            ...
            for line in f:
                ...
                if match:
                    ...
                    for neighbor in neighbors:
                        ...
                        ruas[nome_rua].append({'neighbor_name': neighbor_name, 'price': int(price)})
        
        for rua, vizinhos in ruas.values():
            for tuple in vizinhos:
                    self.General_Graph.add_edge(rua,tuple[0],tuple[1])